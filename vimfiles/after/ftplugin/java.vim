...
inoreabbrev <buffer> jfor for (int i = 0; i < count; i++) {<CR><CR>}<Esc>?count<CR>gn<C-G>
inoreabbrev <buffer> jc class className {<CR><CR>}<Esc>?className<CR>gn<C-G>
inoreabbrev <buffer> jmain public static void main(String[] args) {<CR><CR>}<C-O>k
