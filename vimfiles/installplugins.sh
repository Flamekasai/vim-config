...
git clone https://github.com/tpope/vim-surround.git pack/bundle/opt/vim-surround
git clone https://github.com/tpope/vim-unimpaired.git pack/bundle/opt/vim-unimpaired
git clone https://github.com/godlygeek/tabular.git pack/bundle/opt/vim-tabular
git clone https://github.com/ctrlpvim/ctrlp.vim.git pack/bundle/opt/vim-ctrlp
